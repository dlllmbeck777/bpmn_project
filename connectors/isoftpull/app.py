"""iSoftPull connector proxying requests to the unified applicant backend."""
import os
import time
...
async def handle(body: Dict[str, Any]):
    ...
    upstream = await _credit_backend_request("POST", f"/api/v1/applicants/{applicant_id}/credit-check/isoftpull")
