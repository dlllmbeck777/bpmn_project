...
/* ── Infer execution path: Dijkstra start→end, traced nodes cost 0 (preferred) ── */
function inferPathNodes(allNodes, allEdges, isTracedFn, skippedIds) {
  ...
  // Dijkstra: traced nodes cost 0 (preferred path), non-traced cost 1, skipped = blocked
...
/* ── Flexible node ID matching (handles task_X vs X), case-insensitive ── */
